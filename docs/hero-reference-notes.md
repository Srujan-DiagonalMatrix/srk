...
The new reference uses one horizontal, full-bleed hero instead of a vertically divided white layout. The supplied 1672 × 941 background provides the dark navy copy area, warm office, and right-side portrait as one synchronized composition. Desktop content uses three horizontal zones: copy and actions at left, the 16:9 video at center, and the background portrait at right. The heading retains the supplied capitalization and uses the site's Inter stack with gold limited to “Srujan |”.
